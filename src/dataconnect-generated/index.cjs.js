...
const listPostsForForumRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'ListPostsForForum', inputVars);
}
listPostsForForumRef.operationName = 'ListPostsForForum';
exports.listPostsForForumRef = listPostsForForumRef;

exports.listPostsForForum = function listPostsForForum(dcOrVars, vars) {
